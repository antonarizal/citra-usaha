...
var insert = {
  ...
  hutang : $("#pembayaran").val() == "kredit" ?  grandtotal : 0,
  hutang_dibayar : $("#pembayaran").val() == "kredit" ?  hutang_dibayar : 0,
  hutang_sisa : $("#pembayaran").val() == "kredit" ? hutang_sisa : 0,
  user_id: user.user_id,
  terjual: terjual,
  total_hpp: 0,
  laba_rugi: 0,
  keterangan: "Pembelian " + $("#faktur").val(),
};
$.post(
