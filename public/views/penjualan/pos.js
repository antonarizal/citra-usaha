  ...
  grid: {
    ...
    columns: [
      ...
      },
      {
        ...
        render(record, extra) {
          var html = record.jenis == 'xxx' ? numeral(record.harga_jual).format("0,0") : '<input type="text" style="width:100%;text-align:right" class="form-control-sm form-cart" id="harga_' +
          record.recid +
