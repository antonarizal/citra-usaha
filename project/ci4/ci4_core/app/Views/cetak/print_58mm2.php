...
@font-face {
    ...
    src: URL('/assets/fonts/Merchant Copy.ttf') format('truetype');
}
...
<body onLoad="window.print();" style="width:58mm!important;font-weight:<?=$options->get("printer_font_bold") ? "bold" : "normal"?>;margin-top:<?=$options->get("printer_margin_top") ?>mm;margin-left:<?=$options->get("printer_margin_left") ?>mm">
<?php
...
echo "</pre>";
?>
<!-- <pre style="font-size:18px;font-family:'Merchant Copy';text-align:center">
