...
class RouteUpdate extends BaseCommand
{
    ...
    protected function make_route_file($module) 
    {
        ...
        $configuration_template_admin = "<?php
...
";
        $configuration_template_default = "<?php
...
";
 ...
 $configuration_template = $module == "Admin" ? $configuration_template_admin : $configuration_template_default;
