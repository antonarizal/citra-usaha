 ...
 */
class RouteFilter extends BaseCommand
{
    /**
	 ...
	 * @var string
	 */
    protected $description = 'Filter CodeIgniter HMVC routes for app/Modules folder';
	 ...
	 * @var string
	 */
	protected $usage = 'route:filter [Options]';
...
\$routes->group('$group_name', ['filter' => 'authfilter','namespace' => '$this->namespace_name\\$module\Controllers'], function(\$subroutes){
";
