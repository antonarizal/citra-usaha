  ...
  const template = [
    ...
    },
    {
      ...
      submenu: [
...

        {
          ...
          click() {
            loadMain(mainWindow, `${host}/transaksi/transaksi_hari_ini`);
          },
        },
...

        {
          ...
          click() {
            loadMain(mainWindow, `${host}/retur/pembelian`);
          },
        },
        { type: "separator" },
        
        {
          label: "Piutang",
          click() {
            loadMain(mainWindow, `${host}/piutang/index`);
          },
        },
        {
          label: "Pembayaran Piutang",
          click() {
            loadMain(mainWindow, `${host}/piutang/pembayaran`);
          },
        },
        {
          label: "Hutang",
          click() {
            loadMain(mainWindow, `${host}/hutang/index`);
          },
        },
        { type: "separator" },
      ],
    },
    {
      ...
      submenu: [
        ...
        // },
        {
          label: "Laporan Penjualan Umum",
          click() {
            loadMain(mainWindow, `${host}/laporan/penjualan`);
          },
        },
        {
          label: "Laporan Penjualan Tunai",
          click() {
            loadMain(mainWindow, `${host}/laporan/penjualan_tunai`);
          },
        },
        {
          label: "Laporan Penjualan Kredit",
          click() {
            loadMain(mainWindow, `${host}/laporan/penjualan_kredit`);
          },
        },
        { type: "separator" },

        {
          label: "Laporan Pembelian Umum",
          click() {
            loadMain(mainWindow, `${host}/laporan/pembelian`);
          },
        },
        {
          label: "Laporan Pembelian Tunai",
          click() {
            loadMain(mainWindow, `${host}/laporan/pembelian_tunai`);
          },
        },
        {
          label: "Laporan Pembelian Kredit",
          click() {
            loadMain(mainWindow, `${host}/laporan/pembelian_kredit`);
          },
        },
        { type: "separator" },

        {
          ...
          click() {
            loadMain(mainWindow, `${host}/laporan/piutang`);
          },
        },
        {
          label: "Laporan Hutang",
          click() {
            loadMain(mainWindow, `${host}/laporan/hutang`);
          },
        },
        {
          label: "Laporan Kas",
          click() {
            loadMain(mainWindow, `${host}/laporan/kas`);
          },
        },
      ],
    },
